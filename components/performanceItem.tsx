...
export default function PerformanceItem() {
  return (
    <div className='w-full h-16 bg-white rounded-lg flex justify-between items-center my-4 px-3 text-black'>
            ...
            <div className='flex items-center text-base font-medium'><CircularProgress color='info' sx={{width:'24px',height:'24px',margin:.5,padding:0.5}} variant='determinate' value={86}/> 86% </div>
